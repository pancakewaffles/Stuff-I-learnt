...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public class BulletAssets {
        ...
        public BulletAssets(TextureAtlas atlas) {
            ...
            region = atlas.findRegion(Constants.BULLET_SPRITE);
    ...
    public class ExplosionAssets {
        ...
        public final Animation explosions;
        ...
        public ExplosionAssets(TextureAtlas atlas) {
            ...
            Array<AtlasRegion> explosionsFrames = new Array<AtlasRegion>();
            explosionsFrames.add(atlas.findRegion(Constants.EXPLOSION_LARGE));
            explosionsFrames.add(atlas.findRegion(Constants.EXPLOSION_MEDIUM));
            explosionsFrames.add(atlas.findRegion(Constants.EXPLOSION_SMALL));

            explosions = new Animation(Constants.EXPLOSION_DURATION,explosionsFrames,PlayMode.NORMAL);
    ...
    public class PowerupAssets {
        ...
        public PowerupAssets(TextureAtlas atlas) {
            ...
            region = atlas.findRegion(Constants.POWERUP_SPRITE);
