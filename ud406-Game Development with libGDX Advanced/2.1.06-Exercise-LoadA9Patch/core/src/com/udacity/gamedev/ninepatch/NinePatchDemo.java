...
public class NinePatchDemo extends ApplicationAdapter {
    ...
    public void create() {
        ...
        platform9 = new NinePatch(platform,EDGE,EDGE,EDGE,EDGE);
    ...
    public void render() {
        ...
        batch.draw(platform,viewport.getWorldWidth()/4 - TEST_SIZE_1/2,viewport.getWorldHeight()*3/4 - TEST_SIZE_1/2, TEST_SIZE_1,TEST_SIZE_1);

        // TODO: Draw the platform texture at TEST_SIZE_2
        batch.draw(platform,viewport.getWorldWidth()*3/4 - TEST_SIZE_2/2,viewport.getWorldHeight()*3/4 - TEST_SIZE_2/2, TEST_SIZE_2,TEST_SIZE_2);
        // TODO: Draw the nine patch at TEST_SIZE_1

        platform9.draw(batch,viewport.getWorldWidth()/4 - TEST_SIZE_1/2,viewport.getWorldHeight()*1/4 - TEST_SIZE_1/2, TEST_SIZE_1,TEST_SIZE_1);

        // TODO: Draw the nine patch at TEST_SIZE_2
        platform9.draw(batch,viewport.getWorldWidth()*3/4 - TEST_SIZE_2/2,viewport.getWorldHeight()*1/4 - TEST_SIZE_2/2, TEST_SIZE_2,TEST_SIZE_2);
