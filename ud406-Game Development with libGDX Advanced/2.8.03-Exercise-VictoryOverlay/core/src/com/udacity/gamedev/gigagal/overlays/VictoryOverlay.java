...
public class VictoryOverlay {
    ...
    public void init() {
        ...
        for(int i = 0; i < Constants.EXPLOSION_COUNT;i++){
           Vector2 position = new Vector2(MathUtils.random(0,viewport.getWorldWidth()) , MathUtils.random(0,viewport.getWorldHeight()));
    ...
    public void render(SpriteBatch batch) {
        ...
        font.draw(batch,Constants.VICTORY_MESSAGE,0,viewport.getWorldHeight()/2,viewport.getWorldWidth() , Align.center, false);
