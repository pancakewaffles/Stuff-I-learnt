...
public class TextureDrawing extends ApplicationAdapter {
    ...
    public void render() {
        ...
        //batch.draw(texture,0,0,LOGO_SIZE,LOGO_SIZE);

        // TODO: Then try centering the logo
        batch.draw(texture,viewport.getWorldWidth()/2 - LOGO_SIZE/2,viewport.getWorldHeight()/2 - LOGO_SIZE/2,LOGO_SIZE,LOGO_SIZE);
