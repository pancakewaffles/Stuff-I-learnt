...
public class Enemy {
    ...
    public void update(float delta) {
        ...
        position.y = platform.top + Constants.ENEMY_CENTER.y + Constants.ENEMY_BOB_AMPLITUDE +  Constants.ENEMY_BOB_AMPLITUDE* MathUtils.sin(MathUtils.PI2 * elapsedTime / Constants.ENEMY_BOB_PERIOD);
