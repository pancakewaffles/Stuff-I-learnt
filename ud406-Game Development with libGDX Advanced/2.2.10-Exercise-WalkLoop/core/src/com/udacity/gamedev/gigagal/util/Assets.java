...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public class GigaGalAssets {
        ...
        public GigaGalAssets(TextureAtlas atlas) {
            ...
            walkLeftAnimation = new Animation(Constants.WALK_LOOP_DURATION,walkingLeftFrames, Animation.PlayMode.LOOP);
            ...
            walkRightAnimation = new Animation(Constants.WALK_LOOP_DURATION,walkingRightFrames, Animation.PlayMode.LOOP);
        }
    }
}
