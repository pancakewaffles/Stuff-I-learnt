...
public class GigaGal {
    ...
    private void moveLeft(float delta) {
        ...
        if(jumpState == GROUNDED && walkState != WalkState.WALKING){
    ...
    public void render(SpriteBatch batch) {
        ...
        if (facing == Facing.RIGHT && jumpState != GROUNDED) {
            ...
            float elapsedTime = MathUtils.nanoToSec * (TimeUtils.nanoTime() - walkStartTime);


            // TODO: Select the correct frame from the walking right animation
            region = Assets.instance.gigaGalAssets.walkRightAnimation.getKeyFrame(elapsedTime);
        } else if (facing == Facing.LEFT && jumpState != GROUNDED) {
            ...
            region = Assets.instance.gigaGalAssets.walkLeftAnimation.getKeyFrame(elapsedTime);
