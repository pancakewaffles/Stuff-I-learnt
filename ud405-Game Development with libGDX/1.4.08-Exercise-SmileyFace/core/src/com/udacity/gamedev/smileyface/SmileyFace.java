...
public class SmileyFace extends ApplicationAdapter {
    ...
    private void drawSmileyFace(ShapeRenderer renderer) {
        ...
        renderer.circle(FACE_CENTER_X-EYE_OFFSET,FACE_CENTER_Y+EYE_OFFSET,EYE_RADIUS,EYE_SEGMENTS); // Left Eye
        renderer.circle(FACE_CENTER_X+EYE_OFFSET,FACE_CENTER_Y+EYE_OFFSET,EYE_RADIUS,EYE_SEGMENTS); // Right Eye



        // TODO: Draw a black arc for the mouth (Hint: MOUTH_OUTER_RADIUS)
        renderer.arc(FACE_CENTER_X,FACE_CENTER_Y,MOUTH_OUTER_RADIUS,-180,180,MOUTH_SEGMENTS);

        // TODO: Draw a yellow arc to make the mouth actually look like a mouth (Hint: MOUTH_INNER_RADIUS)
        renderer.setColor(Color.YELLOW);
        renderer.arc(FACE_CENTER_X,FACE_CENTER_Y,MOUTH_INNER_RADIUS,-180,180,MOUTH_SEGMENTS);
