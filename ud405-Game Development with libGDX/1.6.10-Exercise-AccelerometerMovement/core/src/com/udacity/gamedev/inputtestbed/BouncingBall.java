...
public class BouncingBall extends InputAdapter {
    ...
    public void update(float delta) {
        ...
        float xAxis = Gdx.input.getAccelerometerY(); // When the phone is tilted \ , accelerometerY returns a positive value (even though tilted towards negative y-axis). Since xAxis(the direction of acceleration, points in the positve landscape x-axis), we set this to accelerometerY.
        ...
        // Note we want to negate the value, since we want to fall away from the direction of the accelerometer readings <-- ignore this if you don't understand it
