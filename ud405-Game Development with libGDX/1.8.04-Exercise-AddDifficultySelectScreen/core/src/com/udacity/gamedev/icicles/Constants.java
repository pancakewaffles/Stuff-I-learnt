...
public class Constants {
    ...
    public static final Color EASY_COLOR = Color.BLUE;
    public static final Color MEDIUM_COLOR = Color.CYAN;
    public static final Color HARD_COLOR = Color.BLACK;

    // TODO: Add constant for the size of the difficulty world
    public static final float DIFFICULTYSCREEN_SIZE = 480.0f;

    // TODO: Add constant for the radius of the difficulty select "buttons"
    public static final float BUTTON_RADIUS = DIFFICULTYSCREEN_SIZE/9;
    ...
    public static final Vector2 EASY_CENTER = new Vector2(DIFFICULTYSCREEN_SIZE/4,DIFFICULTYSCREEN_SIZE/2);
    public static final Vector2 MEDIUM_CENTER = new Vector2(2*DIFFICULTYSCREEN_SIZE/4,DIFFICULTYSCREEN_SIZE/2);
    public static final Vector2 HARD_CENTER = new Vector2(3*DIFFICULTYSCREEN_SIZE/4,DIFFICULTYSCREEN_SIZE/2);
