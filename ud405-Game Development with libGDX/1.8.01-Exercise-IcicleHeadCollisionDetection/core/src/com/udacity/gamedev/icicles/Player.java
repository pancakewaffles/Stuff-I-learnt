...
public class Player {
    ...
    public boolean hitByIcicle(Icicles icicles) {
        ...
        for(Icicle icicle: icicles.icicleList){
            ...
            if(icicle.position.y > (position.y - Constants.PLAYER_HEAD_RADIUS) && icicle.position.y < (position.y + Constants.PLAYER_HEAD_RADIUS)){
                if(icicle.position.x > (position.x - Constants.PLAYER_HEAD_RADIUS) && icicle.position.x < (position.x + Constants.PLAYER_HEAD_RADIUS)){
                    isHit = true;
                }
            }
