...
import static com.udacity.gamedev.icicles.Constants.GRAVITY;
...
public class Player {
    ...
    public void update(float delta) {
        ...
        float accelerometerInput = xAxis / (GRAVITY * ACCELEROMETER_SENSITIVITY);

        // TODO: Use the accelerometer input to move the player
        position.x += delta * PLAYER_MOVEMENT_SPEED * accelerometerInput;
