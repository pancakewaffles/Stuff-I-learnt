...
public class ReciprocatingMotion extends ApplicationAdapter {
    ...
    public void render() {
        ...
        long elapsedTime = TimeUtils.nanoTime() - initialTime;

        // TODO: Use MathUtils.nanoToSec to figure out how many seconds the animation has been running
        float elapsedSeconds = elapsedTime * MathUtils.nanoToSec;
        ...
        // It's essentially this equation: sin(omega t) i.e. sin(2pif t)
        float x = worldCenterX + MOVEMENT_DISTANCE*MathUtils.sin(MathUtils.PI2 * (elapsedPeriods%1)); // elapsedPeriods%1 gives the fractional/decimal component of elapsedPeriods. This is so that we don't let elapsedPeriods run up too high.
