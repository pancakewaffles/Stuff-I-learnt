...
public class IciclesScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        topScore = max(topScore,icicles.counter);
        ...
        font.draw(batch,"Player Deaths: "+player.deathCount,Constants.HUD_MARGIN,screenViewport.getWorldHeight()-Constants.HUD_MARGIN);

        // TODO: Draw the score and top score in the top right
        font.draw(batch,"Score: "+ icicles.counter +"\nTop Score: "+ topScore,screenViewport.getWorldWidth()-Constants.HUD_MARGIN,screenViewport.getWorldHeight()-Constants.HUD_MARGIN,0, Align.right,false);
