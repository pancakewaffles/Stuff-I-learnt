...
public class Constants {
    ...
    public static final float EASY_SPAWNRATE = 10.0f;
    public static final float MEDIUM_SPAWNRATE = 20.0f;
    public static final float HARD_SPAWNRATE = 30.0f;

    // TODO: Create Difficulty enum holding the spawn rate and label for each difficulty
    public enum Difficulty{
        EASY(EASY_SPAWNRATE, EASY_LABEL),
        MEDIUM(MEDIUM_SPAWNRATE, MEDIUM_LABEL),
        HARD(HARD_SPAWNRATE, HARD_LABEL);
